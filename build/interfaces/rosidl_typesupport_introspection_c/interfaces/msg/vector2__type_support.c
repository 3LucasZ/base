...
#include <stddef.h>
#include "interfaces/msg/vector2__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Vector2__rosidl_typesupport_introspection_c__Vector2_message_member_array[2] = {
  {
    ...
    offsetof(interfaces__msg__Vector2, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__msg__Vector2, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Vector2__rosidl_typesupport_introspection_c__Vector2_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces__msg__Vector2),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, msg, Vector2)() {
