...
#include "interfaces/msg/vector2__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Vector2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Vector2 *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Vector2__handle;
}
